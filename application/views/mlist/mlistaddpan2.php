...
<td><input type = "text" id = "name" name = "name" value = "<?php echo $name?>" size = "45"  readonly ></td>
...
<td width = "50%">PAN</td>
<td width= "50%"><input type = "text" id = "pan" name = "pan" value = "<?php echo $pan?>" size = "45" maxlength = "50" readonly></td>
</tr>
</fieldset>
</table>
<table class = "table1" border = "1" width = "98%">
